...
<template>
  ...
  <SanitisedTextInput
    v-model="planet"
    label="Nombre del planeta de la luna:"
  ...
  <SanitisedTextInput
    ...
    help-title="Número de fauna de la Luna"
    :invalid="!isCostValid"
  ...
  <DateSelect
    v-model="discDate"
    label="¿Cuándo se descubrió esta Luna?"
  ></DateSelect>
  <DateSelect
    v-model="docDate"
    label="¿Cuándo se documentó esta Luna?"
  />
  <SanitisedTextInput
