...
export const translations = {
  en: {
    epic: {
      ...
      subtitle: 'Unified galactic registry of all charted regions under Royal Space Society sovereignty',
      accessTitle: 'Stellar Access Protocol',
      accessText: 'These stellar territories are accessible only to initiates of the Royal Space Society Order',
      securityLevel: 'Cartographic Security: Sigma-9',
      systemUpdate: 'Stellar cartography update: 18/7/2567 (Korvax Cycle)',
    },
    common: {
      title: 'RSS Regions Directory',
      subtitle: 'Central directory of all officially recognized RSS regions',
  ...
  es: {
    ...
    common: {
      ...
      subtitle: 'Directorio central de todas las regiones RSS reconocidas oficialmente',
