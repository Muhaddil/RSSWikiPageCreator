    ...
    common: [
      {
        ...
        description: 'Knowledge base with documentation and star maps',
        icon: 'pi pi-globe'
      },
      {
      ...
      },
      {
        ...
        url: 'https://x.com/RoyalSpaceHub',
        category: 'News',
        description: 'Official RSS Twitter/X account',
        icon: 'pi pi-sort-alt-slash'
      },
      {
        title: 'Reddit Forum',
        ...
        description: 'Community forum for debates and suggestions',
        icon: 'pi pi-comments'
      },
      {
...
export const translations = {
  en: {
    ...
    common: {
      ...
      securityLevel: 'Security Level: Omega-3',
      systemUpdate: 'Last update: 18/7/2024 (Korvax Cycle)',
    }
  },
  es: {
    epic: {
    ...
    common: {
      title: 'RECURSOS ESTRATÉGICOS RSS',
      subtitle: 'Portal central de sistemas esenciales para miembros de la Royal Space Society',
      accessTitle: 'Acceso Prioritario',
      accessText: 'Acceso exclusivo para miembros activos de la RSS',
      securityLevel: 'Nivel de seguridad: Omega-3',
      systemUpdate: 'Última actualización: 09/02/2025 (Ciclo Korvax)',
    }
  }
};
