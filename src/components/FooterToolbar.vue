...
function isFAQPage() {
  return currentUrl.includes('faq.html') || currentUrl.includes('basesdestacadas.html') || currentUrl.includes('rsslinks.html') || currentUrl.includes('censustable.html') || currentUrl.includes('regions.html');
}
