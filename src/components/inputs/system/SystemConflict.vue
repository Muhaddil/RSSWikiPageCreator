  ...
  <InputTableItem>
    <template #label>
      <div class="is-flex is-justify-content-space-between is-align-items-center full-width">
        ...
        <Explainer tooltip="Encontrado en la vista ampliada del mapa galáctico." help-title="Conflicto" help-img="system/conflict">
          Encontrado en la vista ampliada del mapa galáctico.<br>
          El botón para ingresar a la vista ampliada se muestra debajo del cuadro con los detalles del sistema..<br>
          Si no muestra nada, es "Abandonado" o
          "Inexplorado". Esto se puede determinar mirando el valor de la facción.
        </Explainer>
      </div>
    </template>
