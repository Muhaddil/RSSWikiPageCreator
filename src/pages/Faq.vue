...
export default defineComponent({
  ...
  setup() {
    const faqs = ref([
      ...
      { id: 14, question: "¿Cuál es el objetivo principal de la RSS?", answer: "La Royal Space Society (RSS) tiene como objetivo ser una comunidad hispanohablante de apoyo, exploración y documentación en el universo de No Man's Sky. Ofrece recursos, rutas, y ayuda a nuevos jugadores." },
      { id: 15, question: "¿Quién fundó la RSS y cuándo?", answer: "La RSS fue fundada por Oskar1up. El sistema capital Urticalia fue descubierto el 25 de enero de 2020 por Kaos1923 y la fundación oficial ocurrió el 8 de febrero de 2020." },
      { id: 16, question: "¿Por qué se llama Royal Space Society?", answer: "El nombre fue seleccionado por votación en un directo del fundador, tambien, se dice que el nombre proviene de una nave Royal tipo 7 que usaba uno de los fundadores durante los primeros viajes." },
      { id: 17, question: "¿Qué significa que la RSS sea un HUB?", answer: "Significa que ha alcanzado un nivel de actividad suficiente en la wiki (más de 20 miembros y 20 sistemas registrados). Esto le otorga reconocimiento como civilización activa." },
      { id: 18, question: "¿Qué es un HUB Nexus y por qué quiere alcanzarlo la RSS?", answer: "Un HUB Nexus es un nivel superior de reconocimiento. Para alcanzarlo, la RSS debe registrar al menos 120 bases principales de miembros activos en la wiki." },
      { id: 19, question: "¿Qué tipo de gobierno tiene la RSS?", answer: "La RSS se describe como una 'democracia totalitaria': los miembros pueden proponer ideas, pero las decisiones finales las toma el fundador, Oskar1up." },
      { id: 20, question: "¿Qué es RSSWikiPageCreator?", answer: "Es una herramienta, creada por Muhaddil para los miembros de la RSS, que genera automáticamente el código wiki necesario para crear páginas de bases, miembros, naves, etc. Facilita la participación en la wiki sin tener que conocer la sintaxis avanzada." },
      { id: 21, question: "¿Qué actividades realiza la RSS?", answer: "Exploración, documentación de sistemas, creación de bases, registro en censos y participación en eventos comunitarios. También ofrecen soporte a nuevos jugadores." },
      { id: 22, question: "¿Qué es el Censo de Miembros?", answer: "Es un registro de todos los jugadores activos afiliados a la RSS en la wiki. Incluye datos como nombre de jugador, sistema base, plataforma y fecha de ingreso." },
      { id: 23, question: "¿Qué es el Censo de Bases?", answer: "Es un registro de las bases principales de los miembros activos. Cada jugador solo puede registrar una base y debe renovarla anualmente." },
      { id: 24, question: "¿Dónde están ubicadas las regiones oficiales de la RSS?", answer: "Principalmente en la galaxia Euclides, aunque se han expandido a otras regiones documentadas en la wiki de NMS, como Eissentam o Hilbert." },
      { id: 25, question: "¿Qué pasa si mi base no está en una región oficial de la RSS?", answer: "No se recomienda registrar bases fuera de regiones oficiales, ya que podrían ser eliminadas por los administradores de la wiki." },
      { id: 26, question: "¿Qué es el espacio civilizado en la wiki?", answer: "Es una categoría de la wiki que agrupa civilizaciones activas y organizadas como la RSS. Estas civilizaciones siguen reglas específicas y tienen estructuras sociales definidas." },
      { id: 27, question: "¿Qué plantilla debo usar al registrar una base?", answer: 'Debes usar la plantilla Infobox Base que se puede generar con la herramienta <a href="https://muhaddil.github.io/RSSWikiPageCreator/base.html" target="_blank">RSSWikiPageCreator</a>.'},
      { id: 28, question: "¿Qué errores debo evitar al editar la wiki?", answer: "Evita el uso de apóstrofes en nombres de páginas, errores de ortografía en los enlaces y no combines múltiples cambios sin una explicación clara en el resumen de edición. También se deben evitar los siguientes símbolos: ][ & : @ * % $ ? # }{ _ / \\ ´ “ ”" },
      { id: 29, question: "¿Puedo registrar fauna o flora descubierta?", answer: "Sí, puedes crear páginas de criaturas, flora y otros descubrimientos, siempre que uses las plantillas adecuadas y proporciones datos como ubicación y glifos." },
      { id: 30, question: "¿Cómo obtengo las coordenadas de mi base?", answer: "Debes usar los glifos del portal y capturar la secuencia de glifos desde el modo foto dentro del juego. Estas se usan para registrar tu base en la wiki." },
      { id: 31, question: "¿Dónde están listadas todas las páginas relacionadas con la RSS?", answer: "Puedes consultar la categoría 'Royal Space Society' en la wiki de NMS. Allí se agrupan todas las páginas afiliadas, desde bases hasta naves." },
      { id: 32, question: "¿Qué idioma se usa en las páginas de la wiki?", answer: "Las páginas de la RSS están en inglés, pero deben seguir el estilo y formato de la wiki, que utiliza inglés británico y ciertas normas globales." },
      { id: 33, question: "¿Puedo añadir enlaces externos en la wiki?", answer: "Sí, pero se recomienda incluir la información principal directamente en el texto, usando los enlaces solo como referencia complementaria." },
      { id: 34, question: "¿Qué es una región RSS y cómo se define?", answer: "Una región RSS es un área del espacio dentro del universo de No Man's Sky que ha sido oficialmente adoptada y documentada por la comunidad de la Royal Space Society. Estas regiones se registran en la wiki como parte de su expansión organizada." },
      { id: 35, question: "¿Qué significa que un sistema esté 'reclamado' por la RSS?", answer: "Significa que un jugador miembro de la RSS ha registrado ese sistema oficialmente en la wiki, bajo las normas establecidas, y lo ha marcado como parte del territorio explorado por la comunidad." },
      { id: 36, question: "¿Puedo registrar varios sistemas estelares?", answer: "Sí, puedes registrar tantos sistemas como quieras, siempre que sigas el formato correcto y uses el prefijo 'RSS' en el nombre del sistema. Asegúrate de que no estén ya registrados y siempre estén dentro de la región de la RSS." },
      { id: 37, question: "¿Qué diferencia hay entre base y puesto avanzado?", answer: "Una base es una estructura principal desarrollada por un jugador y registrada en el censo. Un puesto avanzado es una base menor o secundaria, no necesariamente registrada oficialmente." },
      { id: 38, question: "¿Qué debo hacer si quiero abandonar la RSS?", answer: "Puedes retirar tus páginas o marcar tu base como inactiva en la wiki. También puedes comunicar tu salida en el Discord oficial para que un encargado de la wiki de la RSS te retire tus bases o las marque como obsoletas." },
      { id: 39, question: "¿La RSS tiene alguna alianza con otras civilizaciones?", answer: "No, la RSS no está en ninguna alianza con otro hub, es decir, no está ni en la Un42 ni en la Federación Intergaláctica. Esto es debido a que la comunidad cree que al entrar en una alianza perderíamos nuestra esencia." },
      { id: 40, question: "¿Cuáles son los eventos comunitarios más destacados organizados por la RSS?", answer: "La RSS ha organizado exploraciones coordinadas, competiciones de construcción de bases, eventos de fotografía y campañas de expansión hacia nuevas regiones, así como misas en la Iglesia de la Santa Mamadisimidad." },
      { id: 41, question: "¿Se pueden registrar sistemas en otras galaxias además de Euclides?", answer: "Sí, pero la prioridad y organización de la RSS está centrada principalmente en Euclides. Se recomienda consultar con los encargados antes de registrar fuera de esa galaxia." },
