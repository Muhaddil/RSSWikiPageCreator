...
export default defineComponent({
  ...
  setup() {
    const faqs = ref([
      ...
      { id: 28, question: "¿Qué errores debo evitar al editar la wiki?", answer: "Evita el uso de apóstrofes en nombres de páginas, errores de ortografía en enlaces y no combines múltiples cambios sin explicación clara en el resumen de edición." },
