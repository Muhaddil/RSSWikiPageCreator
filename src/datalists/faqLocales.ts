...
export const faqLocales: Record<'es' | 'en', FaqLocales> = {
  es: {
    searchPlaceholder: 'Buscar preguntas...',
    noResultsTitle: 'Sin resultados',
    createdBy: 'Creado y mantenido por MoonWatcher75',
    faqs: [
      {
        id: 1,
  ...
  en: {
    ...
    createdBy: 'Created and maintained by MoonWatcher75',
    faqs: [
      {
        id: 1,
        question: 'What is the RSS?',
        answer:
          'The RSS is a Spanish-speaking group of NMS players (although members speaking other languages are also accepted) that has a page on the NMS wiki where the discoveries of its members are registered.',
      },
      {
        id: 2,
        question: 'How does the NMS wiki work?',
        answer:
          'The NMS wiki has administrators who have defined a series of rules for adding pages. These rules are mandatory. Administrators can modify or delete pages that do not respect the rules. To register pages on the wiki, you must create a civilization or a company within civilized space.',
      },
      {
        id: 3,
        question: 'How can I become a member of the RSS?',
        answer: 'To be a member of the RSS you must register as a Fandom user and sign up for the RSS Member Census.',
      },
      {
        id: 4,
        question: 'How can I collaborate with the RSS?',
        answer:
          'You can collaborate by adding pages to the wiki with your discoveries, such as star systems, planets, fauna, flora, ships, freighters, or multi-tools.',
      },
      {
        id: 5,
        question: 'Are there any requirements for naming discoveries?',
        answer:
          "For star systems, it is recommended to add 'RSS' at the beginning of the system name. For planets it is optional, but we appreciate it if it is also added.",
      },
      {
        id: 6,
        question: 'What data and images do I need to register a page on the wiki?',
        answer:
          'In the mentioned tool there is help for each field you need to fill out. If you have any difficulties, you can request assistance on Discord.',
      },
      {
        id: 7,
        question: 'What do I need to register my base in the RSS Base Census?',
        answer:
          'The base must be located in one of the systems registered by the RSS. You can consult the regions registered by the RSS.',
      },
      {
        id: 8,
        question: 'What kind of base can I register in the RSS Base Census?',
        answer:
          'Any base can be registered, but we recommend that it be your main base or a well-developed base. It is possible to change the registered base at any time.',
      },
      {
        id: 9,
        question: 'What do I have to do to maintain my base in the RSS Base Census?',
        answer:
          "The census is updated annually. You must renew your registration every year, preferably in January. To renew, simply edit your base page and change the 'censusrenewal' field to the current year (for example: 'censusrenewal = 2024').",
      },
      {
        id: 10,
        question: 'Why do I not appear in the RSS Member Census if I have my base registered in the Base Census?',
        answer:
          'The wiki administrators decided that players with a base registered in the Base Census cannot appear in the Member Census, just as you can only have one base per player in the base census. It is worth noting that the base census has greater importance for the RSS than the member census. Furthermore, this registration carries the commitment to update the base census entry every year.',
      },
      {
        id: 11,
        question: 'Can I register systems, planets, or bases outside the regions registered by the RSS?',
        answer:
          'It is not recommended to register elements outside the regions registered by the RSS to avoid problems with the wiki administrators.',
      },
      {
        id: 12,
        question: 'Why does it give me an Inline Templates error?',
        answer:
          'That is because you are using an editor that breaks the format created by this website. Change the editor to the classic editor here: <a href="https://nomanssky.fandom.com/wiki/Special:Preferences#mw-prefsection-editing" target="_blank">Classic editor</a>',
      },
      {
        id: 13,
      ...
      {
        id: 14,
        question: 'What is the primary objective of the RSS?',
        answer:
          "The Royal Space Society (RSS) aims to be a Spanish-speaking community for support, exploration, and documentation in the No Man's Sky universe. It offers resources, routes, and help to new players.",
      },
      {
        id: 15,
        question: 'Who founded the RSS and when?',
        answer:
          'The RSS was founded by Oskar1up. The capital system Urticalia was discovered on January 25, 2020 by Kaos1923, and the official foundation occurred on February 8, 2020.',
      },
      {
        id: 16,
        question: 'Why is it called Royal Space Society?',
        answer:
          'The name was selected by vote in a livestream by the founder. Also, it is said that the name comes from a Royal type 7 ship used by one of the founders during the first voyages.',
      },
      {
        id: 17,
        question: 'What does it mean that the RSS is a HUB?',
        answer:
          'It means it has reached a sufficient level of activity on the wiki (more than 20 members and 20 registered systems). This gives it recognition as an active civilization.',
      },
      {
        id: 18,
        question: 'What is a HUB Nexus and why does the RSS want to achieve it?',
        answer:
          'A HUB Nexus is a higher level of recognition. To achieve it, the RSS must register at least 120 main bases of active members on the wiki.',
      },
      {
        id: 19,
        question: 'What kind of government does the RSS have?',
        answer:
          "The RSS describes itself as a 'totalitarian democracy': members can propose ideas, but the final decisions are made by the founder, Oskar1up.",
      },
      {
        id: 20,
        question: 'What is RSSWikiPageCreator?',
        answer:
          'It is a tool created by Muhaddil for RSS members, which automatically generates the wiki code needed to create base, member, ship, etc. pages. It facilitates participation in the wiki without needing to know advanced syntax.',
      },
      {
        id: 21,
        question: 'What activities does the RSS perform?',
        answer:
          'Exploration, system documentation, base building, census registration, and community event participation. They also offer support to new players.',
      },
      {
        id: 22,
        question: 'What is the Member Census?',
        answer:
          'It is a registry of all active players affiliated with the RSS on the wiki. It includes data such as player name, home system, platform, and date of entry.',
      },
      {
        id: 23,
        question: 'What is the Base Census?',
        answer:
          'It is a registry of the main bases of active members. Each player can only register one base and must renew it annually.',
      },
      {
        id: 24,
        question: 'Where are the official RSS regions located?',
        answer:
          'Mainly in the Euclid galaxy, although they have expanded to other documented regions on the NMS wiki, such as Eissentam or Hilbert.',
      },
      {
        id: 25,
        question: 'What happens if my base is not in an official RSS region?',
        answer:
          'It is not recommended to register bases outside of official regions, as they could be deleted by the wiki administrators.',
      },
      {
        id: 26,
        question: 'What is civilized space on the wiki?',
        answer:
          'It is a category of the wiki that groups active and organized civilizations like the RSS. These civilizations follow specific rules and have defined social structures.',
      },
      {
        id: 27,
      ...
      {
        id: 28,
        question: 'What errors should I avoid when editing the wiki?',
        answer:
          'Avoid using apostrophes in page names, spelling errors in links, and do not combine multiple changes without a clear explanation in the edit summary. The following symbols should also be avoided: ][ & : @ * % $ ? # }{ _ / \\ ´ " "',
      },
      {
        id: 29,
        question: 'Can I register discovered fauna or flora?',
        answer:
          'Yes, you can create pages for creatures, flora, and other discoveries, as long as you use the proper templates and provide data such as location and glyphs.',
      },
      {
        id: 30,
        question: 'How do I get the coordinates of my base?',
        answer:
          'You must use the portal glyphs and capture the glyph sequence from the in-game photo mode. These are used to register your base on the wiki.',
      },
      {
        id: 31,
        question: 'Where are all the pages related to the RSS listed?',
        answer:
          "You can check the 'Royal Space Society' category on the NMS wiki. All affiliated pages are grouped there, from bases to ships.",
      },
      {
        id: 32,
        question: 'What language is used on the wiki pages?',
        answer:
          'The RSS pages are in English, but they must follow the style and format of the wiki, which uses British English and certain global rules.',
      },
      {
        id: 33,
        question: 'Can I add external links to the wiki?',
        answer:
          'Yes, but it is recommended to include the main information directly in the text, using links only as complementary references.',
      },
      {
        id: 34,
        question: 'What is an RSS region and how is it defined?',
        answer:
          "An RSS region is an area of space within the No Man's Sky universe that has been officially adopted and documented by the Royal Space Society community. These regions are registered on the wiki as part of their organized expansion.",
      },
      {
        id: 35,
        question: "What does it mean that a system is 'claimed' by the RSS?",
        answer:
          'It means that a player who is a member of the RSS has officially registered that system on the wiki, under the established rules, and marked it as part of the territory explored by the community.',
      },
      {
        id: 36,
        question: 'Can I register multiple star systems?',
        answer:
          "Yes, you can register as many systems as you want, provided you follow the correct format and use the 'RSS' prefix in the system name. Make sure they are not already registered and are always within the RSS region.",
      },
      {
        id: 37,
        question: 'What is the difference between a base and an outpost?',
        answer:
          'A base is a main structure developed by a player and registered in the census. An outpost is a minor or secondary base, not necessarily officially registered.',
      },
      {
        id: 38,
        question: 'What should I do if I want to leave the RSS?',
        answer:
          'You can remove your pages or mark your base as inactive on the wiki. You can also communicate your departure on the official Discord so that a member of the RSS wiki team can remove your bases or mark them as obsolete.',
      },
      {
        id: 39,
        question: 'Does the RSS have any alliance with other civilizations?',
        answer:
          'No, the RSS is not in any alliance with another hub, meaning it is neither in the Un42 nor in the Intergalactic Federation. This is because the community believes that entering an alliance would make us lose our essence.',
      },
      {
        id: 40,
        question: 'What are the most prominent community events organized by the RSS?',
        answer:
          'The RSS has organized coordinated explorations, base building competitions, photography events, and expansion campaigns to new regions, as well as masses in the Church of the Holy Mamadisimidad.',
      },
      {
        id: 41,
        question: 'Can systems be registered in other galaxies besides Euclid?',
        answer:
          'Yes, but the priority and organization of the RSS is mainly centered in Euclid. It is recommended to consult with the managers before registering outside that galaxy.',
      },
    ],
    noResultsMessages: [
      'Have you tried searching for something that makes sense?',
      'Are you sure you spelled it right? I found it on the first try.',
      'Well, if it’s not here, it probably wasn’t that important anyway.',
      'Could it be that you’re looking in the wrong place?',
      'Are you sure that even exists? Because I don’t see anything.',
      'How about trying another search? I would have found it in 5 seconds.',
      'Don’t give up, but... are you sure you typed it correctly?',
      'Hmm, that doesn’t seem to be here. Are you searching for it correctly?',
      'It seems the universe doesn’t have that answer... Are you sure about what you’re looking for?',
      'Did you check if the spelling is correct? Sometimes details matter.',
      'I can’t find anything with that... Maybe it’s a search too advanced for me.',
      'Wow! Are you sure anything with that description exists?',
      'Are you sure that’s the right question? I can’t find it here.',
      'Maybe try searching somewhere else... I see absolutely nothing!',
      'Did you write it correctly? Sometimes a single letter changes everything.',
      'It seems that info is not here, but have you tried another term?',
      'Have you tried a more precise search? This is getting difficult.',
      'Nothing found... maybe we are searching in the wrong place.',
      'I don’t have that, but are you sure it’s even relevant?',
      'Have you tried another term? This is getting interesting.',
      'Are you searching for something that actually exists? Because I can’t find it here.',
      'I don’t know if I’m missing something, but I can’t find anything related.',
      'Hmm... that doesn’t ring a bell. Maybe you need a better search term.',
      'Searching the internet isn’t that hard, is it? You just need to know how to do it.',
      'If you knew how this works, you would find it immediately.',
      'I told you, there’s nothing there, it’s obvious. Better try somewhere else.',
      'I searched for it and found it in 3 seconds. Aren’t you typing it wrong?',
      'If you can’t find anything, maybe it’s because you’re not searching correctly.',
      'Given how easy it is to search for this, I don’t understand how you can’t find it.',
      'I don’t know, I wouldn’t have high hopes for that. Better search for something simpler.',
      'I remember finding that years ago without any trouble, but surely you overcomplicated it.',
      'The answer is right there, but of course, if you don’t know how to search, it’s normal that you can’t find it.',
      'You need to pay more attention, because what you’re looking for is easy to find, I don’t know how you miss it.',
      'I’m telling you, that doesn’t exist or it’s gone. Better search for something else.',
      'Well, if I found it recently and now you can’t, what did you do wrong?',
      'I didn’t even search and I already know what’s there, how did you not find it?',
      'Of course, the answer was right under your nose, but who actually knows how to search, right?',
      'I just don’t get it, it cost me nothing to find it. Did you follow all the steps?',
    ],
  },
};
