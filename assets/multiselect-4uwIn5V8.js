...
`,classes:{root:`p-chip p-component`,image:`p-chip-image`,icon:`p-chip-icon`,label:`p-chip-label`,removeIcon:`p-chip-remove-icon`}}),U={name:`Chip`,extends:{name:`BaseChip`,extends:A,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:Ce,provide:function(){return{$pcChip:this,$parentInstance:this}}},inheritAttrs:!1,emits:[`remove`],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key===`Enter`||e.key===`Backspace`)&&this.close(e)},close:function(e){this.visible=!1,this.$emit(`remove`,e)}},computed:{dataP:function(){return O({removable:this.removable})}},components:{TimesCircleIcon:V}},we=[`aria-label`,`data-p`],Te=[`src`];function Ee(t,r,i,o,s,c){return s.visible?(a(),d(`div`,e({key:0,class:t.cx(`root`),"aria-label":t.label},t.ptmi(`root`),{"data-p":c.dataP}),[n(t.$slots,`default`,{},function(){return[t.image?(a(),d(`img`,e({key:0,src:t.image},t.ptm(`image`),{class:t.cx(`image`)}),null,16,Te)):t.$slots.icon?(a(),h(y(t.$slots.icon),e({key:1,class:t.cx(`icon`)},t.ptm(`icon`)),null,16,[`class`])):t.icon?(a(),d(`span`,e({key:2,class:[t.cx(`icon`),t.icon]},t.ptm(`icon`)),null,16)):p(``,!0),t.label===null?p(``,!0):(a(),d(`div`,e({key:3,class:t.cx(`label`)},t.ptm(`label`)),m(t.label),17))]}),t.removable?n(t.$slots,`removeicon`,{key:0,removeCallback:c.close,keydownCallback:c.onKeydown},function(){return[(a(),h(y(t.removeIcon?`span`:`TimesCircleIcon`),e({class:[t.cx(`removeIcon`),t.removeIcon],onClick:c.close,onKeydown:c.onKeydown},t.ptm(`removeIcon`)),null,16,[`class`,`onClick`,`onKeydown`]))]}):p(``,!0)],16,we)):p(``,!0)}U.render=Ee;var De=P.extend({name:`multiselect`,style:`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
