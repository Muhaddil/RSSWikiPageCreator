...
`,Ue={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},je=Y.extend({name:"chip",style:Ne,classes:Ue}),qe={name:"BaseChip",extends:de,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:je,provide:function(){return{$pcChip:this,$parentInstance:this}}},ee={name:"Chip",extends:qe,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},computed:{dataP:function(){return E({removable:this.removable})}},components:{TimesCircleIcon:_}},We=["aria-label","data-p"],Ze=["src"];function Je(t,e,i,l,s,n){return s.visible?(r(),a("div",o({key:0,class:t.cx("root"),"aria-label":t.label},t.ptmi("root"),{"data-p":n.dataP}),[p(t.$slots,"default",{},function(){return[t.image?(r(),a("img",o({key:0,src:t.image},t.ptm("image"),{class:t.cx("image")}),null,16,Ze)):t.$slots.icon?(r(),v(w(t.$slots.icon),o({key:1,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(r(),a("span",o({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):h("",!0),t.label?(r(),a("div",o({key:3,class:t.cx("label")},t.ptm("label")),O(t.label),17)):h("",!0)]}),t.removable?p(t.$slots,"removeicon",{key:0,removeCallback:n.close,keydownCallback:n.onKeydown},function(){return[(r(),v(w(t.removeIcon?"span":"TimesCircleIcon"),o({class:[t.cx("removeIcon"),t.removeIcon],onClick:n.close,onKeydown:n.onKeydown},t.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):h("",!0)],16,We)):h("",!0)}ee.render=Je;var Xe=Q`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
